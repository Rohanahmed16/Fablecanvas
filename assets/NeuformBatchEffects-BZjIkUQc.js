import{n as e,r as t,t as n}from"./index-JfJ4xEID.js";var r=t(e(),1),i=n(),a=`<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8" />
...
</html>`,C={mode:`dark`,speed:1,size:1,gap:2,length:1,density:1,strokeWidth:1,opacity:1,hue:0,saturation:1,brightness:1},w=`#eef1f6`;function T(e,t,n){return Math.min(n,Math.max(t,e))}function E(e,t,n=1){return Math.max(n,Math.round(e*t))}function D(e){return e===`cylinders`||e===`sphere`?e:`cube`}function O(e,t=3){let n=Number(e).toFixed(t);return n.includes(`.`)?n:`${n}.0`}function k(e,t=`dark`){return e==null?t:e===`light`||e===1||e===`1`?`light`:`dark`}function A(){if(typeof document>`u`||typeof window>`u`)return`dark`;let e=document.documentElement,t=e.dataset.scheme??e.dataset.theme;return t===`light`||t===`dark`?t:window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`}function j(e){let[t,n]=(0,r.useState)(A);return(0,r.useEffect)(()=>{if(!e||typeof document>`u`||typeof window>`u`)return;let t=document.documentElement,r=window.matchMedia(`(prefers-color-scheme: dark)`),i=()=>n(A()),a=new MutationObserver(i);return a.observe(t,{attributes:!0,attributeFilter:[`data-scheme`,`data-theme`]}),r.addEventListener(`change`,i),i(),()=>{a.disconnect(),r.removeEventListener(`change`,i)}},[e]),t}function M(e,t){return typeof e==`function`?e(t):e}var N=`
...
`;function P(e,{mode:t}){let n=e.replaceAll(`time += 0.015;`,`time += 0.015 * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`);return t===`light`&&(n=n.replaceAll(`ctx.fillStyle = '#020804';`,`ctx.fillStyle = '${w}';`).replaceAll(`rgba(52,211,153,`,`rgba(4,120,87,`)),n}var F={constellationField:{title:`Constellation Field`,source:a,supportsMode:!0,background:e=>e===`light`?w:`#070914`,targets:[{selector:`#constellationCanvas`,role:`background`}],patch(e,{size:t,length:n,density:r,strokeWidth:i,mode:a}){let o=e.replace(`const LINK = 160;`,`const LINK = ${Math.round(160*n)};`).replace(`const MAX_NODES = window.innerWidth < 768 ? 40 : 85;`,`const MAX_NODES = window.innerWidth < 768 ? ${E(40,r,8)} : ${E(85,r,12)};`).replace(`radius: Math.random() * 2.4 + 1.8`,`radius: (Math.random() * 2.4 + 1.8) * ${t}`).replace(`ctx.lineWidth = 1;`,`ctx.lineWidth = ${Number(Math.max(.25,i).toFixed(2))};`).replace(`node.x += node.vx;`,`node.x += node.vx * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`).replace(`node.y += node.vy;`,`node.y += node.vy * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`);return a===`light`&&(o=o.replace(`ctx.strokeStyle = '#E6C879';`,`ctx.strokeStyle = '#8B6914';`).replace(`ctx.fillStyle = '#E6C879';`,`ctx.fillStyle = '#8B6914';`)),o}},particleDrift:{title:`Particle Drift`,source:o,supportsMode:!0,background:e=>e===`light`?w:`#030509`,targets:[{selector:`#particle-canvas`,role:`background`}],patch(e,{size:t,length:n,density:r,mode:i}){let a=Math.round(120*n),o=i===`light`?.22:.15,s=e.replace(`Array.from({ length: 90 })`,`Array.from({ length: ${E(90,r,12)} })`).replace(`Array.from({ length: 25 })`,`Array.from({ length: ${E(25,r,4)} })`).replace(`length: Math.random() * 100 + 50,`,`length: (Math.random() * 100 + 50) * ${n},`).replace(`n.y += n.vy; // Slow drift`,`n.y += n.vy * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1); // Slow drift`).replace(`b.y -= b.speed;`,`b.y -= b.speed * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`).replace(`if(d < 120) {`,`if(d < ${a}) {`).replace(`0.15 * (1 - d/120)`,`${o} * (1 - d/${a})`).replace(`ctx.lineWidth = 1.5;`,`ctx.lineWidth = ${Number((1.5*t).toFixed(2))};`);return i===`light`&&(s=s.replaceAll(`rgba(96, 165, 250,`,`rgba(37, 99, 235,`).replaceAll(`rgba(156, 163, 175,`,`rgba(36, 48, 68,`).replace(`ctx.fillStyle = dist < 180 ? '#60A5FA' : 'rgba(36, 48, 68, 0.4)';`,`ctx.fillStyle = dist < 180 ? '#2563EB' : 'rgba(36, 48, 68, 0.55)';`)),s}},particleNetwork:{title:`Particle Network`,source:s,supportsMode:!0,background:e=>e===`light`?w:`#05070d`,targets:[{selector:`#particle-canvas`,role:`background`}],patch(e,{size:t,length:n,density:r,mode:i}){let a=e.replace(`const particleCount = 200;`,`const particleCount = ${E(200,r,40)};`).replace(`this.length = Math.random() * 2 + 0.5;`,`this.length = (Math.random() * 2 + 0.5) * ${n};`).replace(`this.z -= this.speed;`,`this.z -= this.speed * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`).replace(`const fov = 300;`,`const fov = ${Math.round(300/Math.max(.4,t))};`);return i===`light`&&(a=a.replace(`ctx.fillStyle = 'rgba(0, 0, 0, 0.45)';`,`ctx.fillStyle = 'rgba(238, 241, 246, 0.55)';`).replace(`const hue = Math.random() > 0.5 ? '200, 220, 255' : '106, 157, 237';`,`const hue = Math.random() > 0.5 ? '36, 48, 68' : '37, 99, 235';`)),a}},fluxVortex:{title:`Flux Vortex`,source:c,background:`#050505`,targets:[{selector:`#webgl-canvas`,role:`background`}],patch(e,{size:t,density:n}){return e.replace(`const vortexCount = 9500;`,`const vortexCount = ${E(9500,n,1200)};`).replace(`const particlesCount = 300;`,`const particlesCount = ${E(300,n,40)};`).replace(`size: 0.006, // Smaller dots requested`,`size: ${Number((.006*t).toFixed(4))}, // Smaller dots requested`).replace(`size: 0.008,`,`size: ${Number((.008*t).toFixed(4))},`)}},portalField:{title:`Portal Field`,source:l,background:`#05060a`,targets:[{selector:`#webgl-container`,role:`background`}],patch(e,{size:t,length:n}){return e.replace(`float d1 = sdArc(st, center, 0.6, 0.02, 0.15);`,`float d1 = sdArc(st, center, ${O(.6*n,3)}, ${O(.02*t,4)}, 0.15);`).replace(`float d2 = sdArc(st, center, 0.65, 0.06, 0.2);`,`float d2 = sdArc(st, center, ${O(.65*n,3)}, ${O(.06*t,4)}, 0.2);`)}},flowField:{title:`Flow Field`,source:u,background:`#0a0a0a`,targets:[{selector:`#canvas`,role:`background`}],patch(e,{size:t,length:n,density:r}){return e.replace(/<script defer src="https:\/\/static\.cloudflareinsights\.com\/beacon\.min\.js[^>]*><\/script>/,``).replace(`const PARTICLE_COUNT = 2500;`,`const PARTICLE_COUNT = ${E(2500,r,300)};`).replace(`let NOISE_SCALE = 0.0025;`,`let NOISE_SCALE = ${Number((.0025/n).toFixed(6))};`).replace(`time += 0.0008;`,`time += 0.0008 * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||0);`).replace(`let vx = Math.cos(angle) * p.speed * SPEED;`,`let vx = Math.cos(angle) * p.speed * SPEED * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||0);`).replace(`let vy = Math.sin(angle) * p.speed * SPEED;`,`let vy = Math.sin(angle) * p.speed * SPEED * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||0);`).replace(`ctx.lineWidth = p.size;`,`ctx.lineWidth = p.size * ${Number(t.toFixed(3))};`)}},amberHalftone:{title:`Amber Halftone`,source:d,supportsMode:!0,background:e=>e===`light`?w:`#0A0A0A`,targets:[{selector:`#webgl-halftone`,role:`background`}],patch(e,{size:t,length:n,density:r,mode:i}){let a=Number((.085/Math.max(.25,r)).toFixed(4)),o=Math.max(12,Math.ceil(2.8/a)),s=Number((9*t).toFixed(2)),c=Number((6*n).toFixed(2)),l=e.replace(`const gridSize = 20;`,`const gridSize = ${o};`).replace(`positions.push(x * 0.15, y * 0.15, 0);`,`positions.push(x * ${a}, y * ${a}, 0);`).replace(`float animatedScale = scale * (sin(dist * 6.0 - time * 2.5) * 0.5 + 0.5);`,`float animatedScale = scale * (sin(dist * ${O(c,2)} - time * 2.5) * 0.5 + 0.5);`).replace(`gl_PointSize = animatedScale * 5.0;`,`gl_PointSize = animatedScale * ${O(s,2)};`).replace(`material.uniforms.time.value = clock.getElapsedTime();`,`material.uniforms.time.value = clock.getElapsedTime() * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`);return i===`light`&&(l=l.replace(`renderer.setClearColor(0x0A0A0A, 1);`,`renderer.setClearColor(0xeef1f6, 1);`).replace(`color1: { value: new THREE.Color(0xFBBF24) },`,`color1: { value: new THREE.Color(0xB45309) },`).replace(`color2: { value: new THREE.Color(0xFFFFFF) }`,`color2: { value: new THREE.Color(0x1a1f2a) }`)),l}},diagnosticsLayers:{title:`Layered Planes`,source:f,supportsMode:!0,background:e=>e===`light`?w:`#020804`,targets:[{selector:`#main-container article:nth-of-type(1) .flex-grow`,role:`ui`,width:`360px`}],focusCss:N,patch:P},diagnosticsNodes:{title:`Node Cubes`,source:f,supportsMode:!0,background:e=>e===`light`?w:`#020804`,targets:[{selector:`#main-container article:nth-of-type(2) .flex-grow`,role:`ui`,width:`360px`}],focusCss:N,patch:P},diagnosticsFlow:{title:`Flowing Mesh`,source:f,supportsMode:!0,background:e=>e===`light`?w:`#020804`,targets:[{selector:`#main-container article:nth-of-type(3) .flex-grow`,role:`ui`,width:`360px`}],focusCss:N,patch:P},signalParticles:{title:`Signal Particles`,source:p,supportsMode:!0,background:e=>e===`light`?w:`#0a0a0a`,targets:[{selector:`#particle-canvas`,role:`background`}],patch(e,{size:t,length:n,mode:r}){let i=e.replace(`const spacing = 16;`,`const spacing = ${Math.max(6,Math.round(16/Math.max(.35,n)))};`).replace(`const dotRadius = 1.5;`,`const dotRadius = ${Number((1.5*t).toFixed(2))};`).replace(`time += 0.02;`,`time += 0.02 * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`);return r===`light`&&(i=i.replace(`ctx.fillStyle = '#3b82f6'; // Blue highlight`,`ctx.fillStyle = '#1d4ed8'; // Blue highlight`).replace(`ctx.fillStyle = '#8b5cf6'; // Purple highlight`,`ctx.fillStyle = '#5b21b6'; // Purple highlight`).replace("ctx.fillStyle = `rgba(148, 163, 184, ${alpha})`;","ctx.fillStyle = `rgba(36, 48, 68, ${alpha})`;")),i}},skeuomorphicToggle:{title:`Skeuomorphic Toggle`,source:m,supportsMode:!0,defaultMode:`auto`,background:e=>e===`light`?`#f8fafc`:`#0b1220`,targets:[{selector:`#skeuomorphic-toggle`,role:`ui`,width:`192px`}],focusCss:`
#skeuomorphic-toggle {
...
`,patch(e,{variant:t,size:n,length:r,mode:i}){let a=D(t),o={cube:`<!-- Section 01: Hypercube -->`,cylinders:`<!-- Section 02: Logic Cylinders -->`,sphere:`<!-- Section 03: Esoteric Sphere -->`}[a],s=e.replace(`${o}
        <div class="group`,`${o}
        <div data-wireframe-selected="${a}" class="group`).replace(`this.angleY += 0.005;`,`this.angleY += 0.005 * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`).replace(`this.angleX += 0.002;`,`this.angleX += 0.002 * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`).replace(`const s = 80;`,`const s = ${Math.round(80*r)};`).replace(`const r = 70;`,`const r = ${Math.round(70*r)};`).replace(`const s = 50; `,`const s = ${Math.round(50*r)}; `).replace(`this.ctx.lineWidth = 0.8;`,`this.ctx.lineWidth = ${Number((.8*n).toFixed(2))};`);return i===`light`&&(s=s.replace("this.ctx.strokeStyle = `rgba(255, 255, 255, ${alpha * 0.4})`;","this.ctx.strokeStyle = `rgba(26, 31, 42, ${alpha * 0.45})`;").replace("this.ctx.fillStyle = `rgba(255, 255, 255, ${alpha})`;","this.ctx.fillStyle = `rgba(26, 31, 42, ${alpha})`;")),s}},defenseLines:{title:`Defense Lines`,source:b,supportsMode:!0,background:e=>e===`light`?`#f4ecec`:`#120303`,targets:[{selector:`#bg-canvas`,role:`background`}],patch(e,{size:t,length:n,density:r,mode:i}){let a=e.replace(`const particleCount = window.innerWidth < 768 ? 40 : 100;`,`const particleCount = window.innerWidth < 768 ? ${E(40,r,8)} : ${E(100,r,16)};`).replace(`baseLength: Math.random() * 80 + 20,`,`baseLength: (Math.random() * 80 + 20) * ${n},`).replace(`p.y -= p.speedY * 1.5 * (1 + centerProximity * 0.5);`,`p.y -= p.speedY * 1.5 * (1 + centerProximity * 0.5) * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`).replace(`ctx.lineWidth = 0.5;`,`ctx.lineWidth = ${Number((.5*t).toFixed(2))};`);return i===`light`&&(a=a.replaceAll(`rgba(220, 38, 38, 0)`,`rgba(153, 27, 27, 0)`).replace("grad.addColorStop(0.5, `rgba(255, ${38 + brightness}, ${38 + brightness}, ${currentOpacity})`);","grad.addColorStop(0.5, `rgba(185, ${20 + brightness * 0.55}, ${20 + brightness * 0.55}, ${currentOpacity})`);")),a}},overrideGrid:{title:`Override Grid`,source:x,supportsMode:!0,background:e=>e===`light`?w:`#050505`,targets:[{selector:`#grid-canvas`,role:`background`}],patch(e,{size:t,gap:n,mode:r}){let i=Math.max(8,Math.round(t)),a=Math.max(0,Math.round(n)),o=e.replace(`const blockSize = 48;`,`const blockSize = ${i};`).replace(`const blockGap = 2;`,`const blockGap = ${a};`).replace(`time += 0.04;`,`time += 0.04 * ((window.__SF_CONTROLS&&window.__SF_CONTROLS.speed)||1);`);return r===`light`&&(o=o.replace("ctx.fillStyle = `rgba(249, 115, 22, ${alpha})`;","ctx.fillStyle = `rgba(194, 65, 12, ${alpha * 1.35})`;")),o}},topoField:{title:`Topo Field`,source:S,supportsMode:!0,background:e=>e===`light`?w:`#000000`,targets:[{selector:`#topo-canvas`,role:`background`}],patch(e,{length:t,density:n,mode:r}){let i=e.replace(`float noiseScale = 1.4;`,`float noiseScale = ${O(1.4*t,3)};`).replace(`float numBands = 10.0;`,`float numBands = ${O(10*n,2)};`);return r===`light`&&(i=i.replace(`gridLines = clamp(gridLines, 0.0, 1.0) * 0.12;`,`gridLines = clamp(gridLines, 0.0, 1.0) * 0.55;`).replace(`float topoLines = smoothstep(0.02, 0.00, triangleWave) * 0.45;`,`float topoLines = smoothstep(0.03, 0.00, triangleWave) * 0.95;`).replace(`vec3 color = vec3(0.0);
                    color += vec3(1.0) * gridLines;
...
<\/script>`;return o.replace(/<head([^>]*)>/i,`<head$1>${c}${s}`).replace(/<\/body>/i,`${l}</body>`)}function L({definition:e,variant:t=`cube`,mode:n,speed:a=C.speed,size:o=C.size,gap:s=C.gap,length:c=C.length,density:l=C.density,strokeWidth:u=C.strokeWidth,opacity:d=C.opacity,hue:f=C.hue,saturation:p=C.saturation,brightness:m=C.brightness,className:h,style:g}){let _=(0,r.useRef)(null),v=n??e.defaultMode??C.mode,y=j(v===`auto`),b=v===`auto`?y:k(v,C.mode),x=M(e.background,b),S=T(a,0,3),w=T(o,.05,200),E=T(s,0,64),D=T(c,.35,2.5),O=T(l,.25,2.5),A=T(u,.25,8),N=T(d,.05,1),P=T(f,-180,180),F=T(p,0,2),L=T(m,.35,1.65),R=(0,r.useMemo)(()=>I(e,{variant:t,mode:b,speed:C.speed,size:w,gap:E,length:D,density:O,strokeWidth:A,opacity:C.opacity}),[e,b,O,E,D,w,A,t]);(0,r.useEffect)(()=>{let e=_.current?.contentWindow;e&&e.postMessage({type:`threeui-controls`,controls:{mode:b,speed:S,size:w,gap:E,length:D,density:O,strokeWidth:A,opacity:N}},`*`)},[b,O,E,D,N,w,S,A,R]);let z=P===0&&F===1&&L===1?void 0:`hue-rotate(${P}deg) saturate(${F}) brightness(${L})`;return(0,i.jsx)(`iframe`,{ref:_,className:h,title:e.title,srcDoc:R,sandbox:`allow-scripts`,loading:`eager`,style:{display:`block`,width:`100%`,height:`100%`,border:0,background:x,filter:z,...g}})}function R(e){return function(t){return(0,i.jsx)(L,{...t,definition:e})}}F.constellationField,F.particleDrift,F.particleNetwork;var z=R(F.fluxVortex),B=R(F.portalField),V=R(F.flowField),H=R(F.amberHalftone);F.diagnosticsLayers,F.diagnosticsNodes,F.diagnosticsFlow;var U=R(F.signalParticles);F.skeuomorphicToggle;var W=R(F.matrixField);F.gatewayFlow,F.connectivityGraph,F.interfaceLines,F.wireframeForms,F.defenseLines;var G=R(F.overrideGrid);F.topoField;export{H as AmberHalftone,V as FlowField,z as FluxVortex,W as MatrixField,G as OverrideGrid,B as PortalField,U as SignalParticles};